...
import src.ml_load_big_data as ml_load
import pickle
import src.ml_plot_nn_big_data as ml_plot_nn
import os
import math
...
def train_wrapper(datadir,
    ...
    if not only_plot:
        #trainfile = datadir + training_expt + "_train.nc"
        #testfile = datadir + training_expt + "_test.nc"
        trainfile = "/ocean/projects/ees220005p/gmooers/GM_Data/training_data/Training_Parts/P1_G_Train_TTTTFTFFFfile_0_to_160.nc"
        testfile = "/ocean/projects/ees220005p/gmooers/GM_Data/training_data/Training_Parts/P2_G_Train_TTTTFTFFFfile_160_to_320.nc"
        if rewight_outputs == True:
            #weights = datadir + training_expt + "_weight.nc"
            weights = "/ocean/projects/ees220005p/gmooers/GM_Data/training_data/Training_Parts/P1_G_Train_TTTTFTFFFfile_0_to_160_w8s.nc"
        else:
            weights=None
        ...
        if do_nn:
            ...
            variables = xr.open_mfdataset(trainfile, chunks=chunk)
    ...
    figpath = plotting_path + est_str + training_expt + '/'
    if do_nn:
