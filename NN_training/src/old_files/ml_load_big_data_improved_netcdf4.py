...
def LoadDataStandardScaleData_v3(traindata,
    ...
    train_variables = nc.Dataset(traindata, mode='r')
    test_variables = nc.Dataset(testdata, mode='r')
    ...
    for i in range(len(input_vert_vars)):
        print("train:", i)
        train_inputs[input_vert_vars[i]] = train_variables[input_vert_vars[i]][...,:training_data_percentage]
        print("test:", i)
        test_inputs[input_vert_vars[i]] = test_variables[input_vert_vars[i]]

    for i in range(len(output_vert_vars)):
        print("train:", i)
        train_outputs[output_vert_vars[i]] = train_variables[output_vert_vars[i]][...,:training_data_percentage]
        print("test:", i)
        test_outputs[output_vert_vars[i]] = test_variables[output_vert_vars[i]]
